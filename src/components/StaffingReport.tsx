                ...
                <tbody>
                  {staffingData.map(person => (
                    <tr key={person.personId}>
                      <td className="border-2 border-gray-400 p-2 text-center bg-gray-200">{person.personCode}</td>
                      <td className="border-2 border-gray-400 p-2 text-left bg-gray-200">{person.personName}</td>
                      <td className="border-2 border-gray-400 p-2 text-center bg-gray-200">{person.categoria}</td>
                      <td className="border-2 border-gray-400 p-2 text-center bg-gray-200">{person.grupo}</td>
                      <td className="border-2 border-gray-400 p-2 text-center bg-gray-200">{person.oficina}</td>
