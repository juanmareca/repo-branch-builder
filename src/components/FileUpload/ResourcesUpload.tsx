                     ...
                     <div className="mt-4 p-3 bg-white rounded border border-blue-200">
                       <p className="text-sm font-semibold text-blue-800 mb-2">Ejemplo de fichero Excel para cargar:</p>
                        <img 
                          ...
                          className="w-full rounded border border-gray-300 shadow-sm cursor-pointer transition-all duration-500 hover:scale-[2.5] hover:z-50 hover:shadow-2xl hover:fixed hover:top-1/2 hover:left-1/2 hover:-translate-x-1/2 hover:-translate-y-1/2 hover:max-w-none hover:w-auto hover:h-auto"
