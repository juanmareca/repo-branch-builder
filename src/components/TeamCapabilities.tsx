...
const TeamCapabilities: React.FC<TeamCapabilitiesProps> = ({ 
  ...
  const getSAPModuleInfo = (moduleName: string): string => {
    const modules: { [key: string]: string } = {
      ...
      'SAP GRC': 'SAP GRC: Governance, Risk and Compliance (Gobierno Corporativo, Gestión de Riesgos y Cumplimiento Normativo). Conjunto de soluciones SAP diseñado para controlar accesos y autorizaciones, gestionar riesgos corporativos, detectar y prevenir fraudes, y cumplir con normativas legales y auditorías internas/externas. Componentes principales: Access Control (GRC-AC para gestión de usuarios, roles y segregación de funciones SoD, previene accesos indebidos), Process Control (GRC-PC para supervisar y documentar controles internos, automatiza auditorías), Risk Management (GRC-RM para identificar, evaluar y monitorizar riesgos empresariales), Audit Management (GRC-AM para planificación y ejecución de auditorías internas), Fraud Management (detección y análisis de actividades sospechosas o fraudulentas). Funciones principales: gestionar solicitudes de acceso de usuarios, prevenir conflictos de segregación de funciones, automatizar controles de autorización y cumplimiento, monitorizar usuarios con acceso crítico, detectar automáticamente conflictos de roles. Integraciones: FI/CO, MM, SD, HR para controlar accesos y riesgos por módulo, IDM (SAP Identity Management) para gestionar identidades de usuarios, SAP Audit Logs para analizar actividad de usuarios. En S/4HANA: totalmente compatible y actualizado con versiones on-premise y cloud, integración nativa con SAP Fiori, automatización de workflows y alertas en tiempo real, preparado para auditorías externas SOX, GDPR, ISO 27001. Ideal para empresas medianas o grandes con procesos financieros o regulatorios sensibles, que necesiten cumplir auditorías, manejen datos confidenciales y busquen reducir riesgos operativos y legales.',
